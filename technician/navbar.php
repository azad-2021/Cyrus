<nav class="navbar navbar-expand-lg navbar-light" style="background-color: #E0E1DE;" id="nav">
  <div class="container-fluid" align="center">
    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown" align="center">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link" aria-current="page" href="deleteapid.php?apid=<?php echo $approvalID.'&empid='.$EmployeeID  ?>">Home</a>
        </li>
      <li class="nav-item">
        <a hidden="" class="nav-link" href="logout.php">Logout</a>
      </li>
      </ul>
    </div>
  </div>
