              ...
              <div class="col-md-12">
                ...
                <form class="needs-validation form-control novalidate rounded-corner" method="POST" style="margin-bottom: 5px;">
                  <div class="row g-3">
                    ...
                    <div class="col-lg-6">
                      <select id="Organization" class="form-control rounded-corner" name="Bank" required>
                        <option value="">Organization</option>
                        <?php
                        $BankData="Select * from projects.Organization order by OrganizationName";
                    ...
                    <div class="col-lg-6">
                      <select id="Division" class="form-control rounded-corner" name="Division" required>
