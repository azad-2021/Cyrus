...
if (!empty($EmployeeCodeP))
{
  ...
  join branchdetails on jobcardmain.BranchCode=branchdetails.BranchCode WHERE jobcardmain.EmployeeCode=$EmployeeCodeP and jobcardmain.VisitDate between '$SDate' and '$EDate' order by VisitDate";
...
if (!empty($EmployeeCodePP))
{
  ...
  WHERE billbook.EmployeeCode=$EmployeeCodePP and Cancelled=0 and BillDate between '$SDate' and '$EDate'";
  $result4=mysqli_query($con2,$query4);
