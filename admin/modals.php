        ...
        <form class="row g-3 needs-validation" novalidate id="form2" name="form">
          <center>
            <div class="col-md-4">
              ...
              <input type="text" class="form-control my-select3" id="forder" name="forder" required>
            </div>
          </center>
        </div>
        ...
        <form class="row g-3 needs-validation" novalidate id="formC" name="form">
          <center>
            <div class="col-md-4">
              ...
              <input type="text" class="form-control my-select3" id="fcomplaint" name="fcomplaint" required>
            </div>
          </center>
        </div>
        ...
        <form class="row g-3 needs-validation" novalidate id="formJ" name="form">
          <center>
            <div class="col-md-4">
              ...
              <input type="text" class="form-control my-select3" id="fjobcard" name="fjobcard" required>
            </div>
          </center>
        </div>
      ...
      <div class="modal-body">
        ...
        <form class="row g-3 needs-validation" novalidate id="formB" name="form">
          ...
          <div class="col-md-6">
            ...
            <input type="text" class="form-control my-select3" id="fbranch" name="fbranch" required>
          </div>
        </div>
        <div class="modal-footer">
