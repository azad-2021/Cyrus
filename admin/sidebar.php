    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#tables-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-layout-text-window-reverse"></i><span>Employee Access</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        
        <ul id="tables-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">

          <li class="nav-heading" style="font-size:15px">Executive</li>
          <li>
          ...
          <li class="nav-heading" style="font-size:15px">Verification</li>
          <li>
          ...
          <li class="nav-heading" style="font-size:15px">Jobcard Entry</li>
          <li>
