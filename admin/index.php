                ...
                while($row = mysqli_fetch_array($result)){
                  ...
                  if ($row1["AttendedOrders"]!=0 or $row2["AttendedAMC"]!=0 or $row3["AttendedComplaints"]!=0 or $PendingWork>0) {
                    ...
                    <tr>
                      ...
                      <td> <a href="#" class="view_WorkReportO" id="<?php print $EmployeeCode ?> " data-bs-target="#WorkReport"><?php echo $row1["AttendedOrders"]; ?></a></td>
                      <td> <a href="#" class="view_WorkReportC" id="<?php print $EmployeeCode ?> " data-bs-target="#ReportC"><?php echo $row3["AttendedComplaints"]; ?></a></td>
                      <td> <a href="#" class="view_WorkReportA" id="<?php print $EmployeeCode ?> " data-bs-target="#ReportAMC"><?php echo $row2["AttendedAMC"]; ?></a></td>
                      ...
                      <td> <a href="#" class="view_WorkReportB" id="<?php print $EmployeeCode ?> " data-bs-target="#ReportAMC"><?php echo $row4["sum(TotalBilledValue)"]; ?></a></td>
